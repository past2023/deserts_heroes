...
(function () {
  ...
  const lights=[
    ...
    { module:0, x:75, y:386, type:'lamp', color:'#ffb44a', r:16, pulse:1.7, intensity:0.62 },
    { module:0, x:75, y:418, w:27, h:9, type:'screen', color:'#4af1ff', r:21, pulse:3.2, intensity:0.58 },
    ...
    { module:0, x:239, y:124, type:'lamp', color:'#ff9a2a', r:29, pulse:1.1, intensity:0.80 },
    { module:0, x:1000, y:141, type:'lamp', color:'#ffb44a', r:24, pulse:1.4, intensity:0.70 },
    ...
    { module:0, x:1261, y:456, type:'lamp', color:'#ffaa3a', r:20, pulse:1.3, intensity:0.58 },
    { module:0, x:1249, y:416, w:30, h:8, type:'screen', color:'#58f0ff', r:18, pulse:2.8, intensity:0.52 },
    { module:0, x:920, y:538, type:'fire', color:'#ff6a18', r:30, pulse:11, intensity:0.82 },

    // Module 1 — mid02b (broken circular)
    { module:1, x:76, y:385, type:'lamp', color:'#ffaa3a', r:18, pulse:1.6, intensity:0.60 },
    ...
    { module:1, x:1001, y:139, type:'lamp', color:'#ff9a2a', r:24, pulse:1.2, intensity:0.72 },
    { module:1, x:1232, y:303, type:'lamp', color:'#ffaa3a', r:20, pulse:1.5, intensity:0.58 },
    { module:1, x:1249, y:416, w:30, h:8, type:'screen', color:'#58f0ff', r:18, pulse:2.8, intensity:0.50 },
    { module:1, x:1002, y:149, type:'fire', color:'#ff6a18', r:26, pulse:10, intensity:0.80 },

    // Module 2 — mid03b (suspended ship)
    { module:2, x:75, y:386, type:'lamp', color:'#ffaa3a', r:18, pulse:1.7, intensity:0.60 },
    { module:2, x:239, y:124, type:'lamp', color:'#ff9a2a', r:27, pulse:1.3, intensity:0.76 },
    { module:2, x:660, y:459, w:37, h:11, type:'screen', color:'#4af1ff', r:26, pulse:2.2, intensity:0.60 },
    { module:2, x:922, y:538, type:'fire', color:'#ff6a18', r:32, pulse:10, intensity:0.86 },
    { module:2, x:1000, y:140, type:'lamp', color:'#ffb44a', r:24, pulse:1.4, intensity:0.72 },
    { module:2, x:1116, y:116, w:28, h:11, type:'screen', color:'#42f2ff', r:22, pulse:2.4, intensity:0.58 },
    { module:2, x:1262, y:464, type:'lamp', color:'#ffaa3a', r:20, pulse:1.5, intensity:0.60 },
    ...
    { module:3, x:76, y:385, type:'lamp', color:'#ffaa3a', r:18, pulse:1.7, intensity:0.60 },
    { module:3, x:69, y:418, w:25, h:9, type:'screen', color:'#4aff88', r:20, pulse:2.5, intensity:0.50 },
    { module:3, x:312, y:400, type:'electric', color:'#5affff', r:26, pulse:18, intensity:0.62 },
    { module:3, x:502, y:400, type:'electric', color:'#7af4ff', r:28, pulse:14, intensity:0.66 },
    ...
    { module:3, x:917, y:165, type:'lamp', color:'#ffaa3a', r:20, pulse:1.8, intensity:0.56 },
    { module:3, x:1270, y:500, type:'lamp', color:'#ffb44a', r:16, pulse:1.6, intensity:0.48 },

    // Module 4 — mid06b (elevator lab)
    { module:4, x:75, y:386, type:'lamp', color:'#ffaa3a', r:17, pulse:1.6, intensity:0.58 },
    { module:4, x:69, y:418, w:26, h:9, type:'screen', color:'#4aff88', r:21, pulse:2.8, intensity:0.50 },
    { module:4, x:239, y:124, type:'lamp', color:'#ff9a2a', r:18, pulse:1.2, intensity:0.58 },
    { module:4, x:902, y:185, type:'lamp', color:'#ffb44a', r:23, pulse:1.3, intensity:0.70 },
    { module:4, x:828, y:538, type:'fire', color:'#ff7a22', r:30, pulse:10, intensity:0.82 },
    ...
    { module:4, x:1075, y:193, w:38, h:30, type:'screen', color:'#4af1ff', r:28, pulse:2.4, intensity:0.60 },
    { module:4, x:1245, y:395, type:'lamp', color:'#ffaa3a', r:18, pulse:1.5, intensity:0.56 },
    { module:4, x:1249, y:416, w:30, h:8, type:'screen', color:'#5afcff', r:18, pulse:2.5, intensity:0.50 },

    // Module 5 — mid07b (sand hangar)
    { module:5, x:362, y:409, type:'lamp', color:'#ffaa3a', r:18, pulse:1.6, intensity:0.52 },
    { module:5, x:962, y:349, type:'lamp', color:'#ffaa3a', r:17, pulse:1.5, intensity:0.50 },
    { module:5, x:976, y:385, type:'lamp', color:'#ffaa3a', r:14, pulse:1.4, intensity:0.50 },
    { module:5, x:976, y:410, type:'lamp', color:'#ff4d38', r:20, pulse:2.2, intensity:0.70 },
    { module:5, x:940, y:510, type:'lamp', color:'#ffaa3a', r:16, pulse:1.6, intensity:0.52 },
    ...
    { module:5, x:1245, y:380, type:'lamp', color:'#ff4d38', r:17, pulse:2.4, intensity:0.46 },
    ...
    { module:6, x:76, y:385, type:'lamp', color:'#ffaa3a', r:17, pulse:1.6, intensity:0.56 },
    { module:6, x:827, y:538, type:'fire', color:'#ff7a22', r:30, pulse:11, intensity:0.78 },
    { module:6, x:828, y:536, type:'lamp', color:'#ffb44a', r:20, pulse:1.3, intensity:0.56 },
    { module:6, x:1003, y:142, type:'lamp', color:'#ffb44a', r:20, pulse:1.3, intensity:0.56 },
    { module:6, x:1077, y:196, w:36, h:30, type:'screen', color:'#4af1ff', r:28, pulse:2.6, intensity:0.58 },
    { module:6, x:1245, y:395, type:'lamp', color:'#ff4d38', r:17, pulse:2.2, intensity:0.48 },
    { module:6, x:1249, y:416, w:30, h:8, type:'screen', color:'#5afcff', r:18, pulse:2.5, intensity:0.46 },

    // Module 7 — mid05b (desert exit final)
    { module:7, x:1089, y:190, type:'lamp', color:'#ffb44a', r:24, pulse:1.4, intensity:0.62 },
  ...
  function drawBackground(g,camX,time,VW,VH){
    ...
    for(const lt of lights){
      ...
      if(lt.type==='lamp'){
        ...
        // CSS blend-mode fire: many rising radial-gradient particles with
        // lighter blend, creating an organic flame from overlapping soft circles.
        g.globalCompositeOperation='lighter';
        const fireW = lt.r * 2.2;
        const fireH = lt.r * 2.8;
        const pCount = 18;
        for(let p = 0; p < pCount; p++){
          const seed = lt.x * 137.3 + p * 79.19;
          const delay = (seed % 1.0);
          const cycle = (time * (0.9 + (p % 5) * 0.12) + delay) % 1.0;
          const rise = cycle;
          const px = screenX + ((seed * 0.37) % 1.0 - 0.5) * fireW;
          const py = screenY - rise * fireH;
          const scale = 1.0 - rise * 0.7;
          const alpha = rise < 0.15 ? rise / 0.15 : rise > 0.7 ? (1 - rise) / 0.3 : 1;
          const radius = (6 + (p % 4) * 2) * scale * intensity;
          if(radius < 1 || alpha < 0.02) continue;
          // Outer glow
          const grad = g.createRadialGradient(px, py, 0, px, py, radius);
          grad.addColorStop(0, 'rgba(255,200,60,0.9)');
          grad.addColorStop(0.3, lt.color);
          grad.addColorStop(1, 'rgba(80,20,0,0)');
          g.globalAlpha = alpha * 0.7 * intensity;
          g.fillStyle = grad;
          g.beginPath(); g.arc(px, py, radius, 0, Math.PI * 2); g.fill();
          // Hot inner core
          if(p % 3 === 0){
            const cr = radius * 0.45;
            g.globalAlpha = alpha * 0.5 * intensity;
            g.fillStyle = '#fff8cc';
            g.beginPath(); g.arc(px, py - 1, cr, 0, Math.PI * 2); g.fill();
          }
        }
        // Embers
        if(Math.random()<0.18 && window.G && G.particles){
          G.particles.push({kind:'ember',x:worldX+(Math.random()-0.5)*14,y:screenY-8,vx:(Math.random()-0.5)*55,vy:-65-Math.random()*75,t:0,life:0.5+Math.random()*0.5,color:Math.random()<0.5?'#ff9a2a':'#ffe28a',size:1.5+Math.random()*3,grav:-15,drag:0.85});
        }
