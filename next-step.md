...
Runtime systems have advanced beyond some historical specifications in this file. For a new chat or production phase, read `docs/current-runtime-status.md`, `docs/world-story-bible.md`, and `docs/next-phase-handoff.md` (synchronized 2026-07-25). Latest changes include the carousel character select, reference-image tutorial platforms, malfunctioning tutorial CRT/electric FX, pilar02 smoke/electric foreground, drill-tip Ally Tank 02 laser origin, ally tank dust/exhaust, Level 1 separated rising UFO/BigShip03 ship-platform section, and alien-glyph loading text.
