...
* **Game feel**: hit-stop, recoil, animated brass casings, multi-lobed procedural muzzle cones, per-weapon gradient tracers, distinct enemy fire families, hard white impact cores, concentric hit rings, long arcade impact rays, restrained explosion screen flashes, layered smoke/fire, non-parallax flame/smoke/bubble lava pits, casino-style coin awards for destroyed helicopters/vehicles/boss, guided-missile exhaust and lock indicators, screen shake, jump buffering + coyote time, and two full procedural music identities. All combat FX are generated internally with Canvas and WebAudio.
