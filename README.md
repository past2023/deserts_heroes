...
* **Desert scenery**: the corrected palm/cactus set, `bigship03.png` high ship platform decoration, and all three exact no-repeat panoramas are active: `sky01.png` (1160×540 at 3%), `mountain01.png` (2156×540 at 18%), and `dune02.png` (6807×576 at 45%/58% render scale).
