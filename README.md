...
* **Pixelated language-neutral loading screens**: mission, tutorial, map, and rift loading overlays use animated alien/pixel glyphs and chunky stepped bars instead of English status text.
